...
public class GuestPreferences implements Serializable {
    ...
    private String theme = "duran";

    private String layout = "duran";
    ...
    private String nameApp = "ORIGAMI-GT";
    private String titlePage = nameApp;
    ...
    public void init() {
        ...
        themeColors.put("new", "#456F9B");
        themeColors.put("duran", "#007BA0");
    }
    ...
    public String getTitlePage() {
        if (JsfUtil.getSessionBean("titlePage") != null) {
            titlePage = (String) JsfUtil.getSessionBean("titlePage");
            JsfUtil.setSessionBean("titlePage", null);
        }
        return titlePage;
    }
