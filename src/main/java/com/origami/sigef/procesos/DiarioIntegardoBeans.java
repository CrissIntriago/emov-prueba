 ...
 */
@Named(value = "diarioIntegradoProcesoView")
@ViewScoped
public class DiarioIntegardoBeans extends BpmnBaseRoot implements Serializable {
            ...
            switch (getTramite().getTipoTramite().getAbreviatura()) {
                ...
                case "PRHEXSU":
                    if (rechazoRol) {
                        ...
                        CatalogoItem tipoRegistrado = catalogoItemService.getEstadoRol("registrado-rol");
                        tipoRolSeleccionado.setEstadoAprobacion(tipoRegistrado);
                    ...
                    break;
                default:
                    getParamts().put("usuarioRen", clienteService.getrolsUser(RolUsuario.contador));
                    break;
            }
            if (saveTramite() == null) {
                return;
