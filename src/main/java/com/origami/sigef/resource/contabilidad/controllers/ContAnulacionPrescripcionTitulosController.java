 ...
 */
@Named(value = "contAnulacionPrescripcionTitulosView")
@ViewScoped
public class ContAnulacionPrescripcionTitulosController implements Serializable {
    ...
    public void updateListDiario() {
        if (opcionBusqueda.getAnio() != null && (fechaDesde.before(fechaHasta) || fechaDesde.equals(fechaDesde))) {
            contDiarioGeneralList = contRegistroContable.getTesoreriaList(MOD_CONTABILIDAD.ANULAR_PRESCRIPCION, fechaDesde, fechaHasta, null, false);
            contDiarioGeneralDetalleList = new ArrayList<>();
        } else {
    ...
    public void save() {
        ...
        if (!contDiarioGeneralList.isEmpty()) {
            temp = contRegistroContable.findRelacionModulos(contDiarioGeneralSeleccionadoList, MOD_CONTABILIDAD.ANULAR_PRESCRIPCION);
        }
    ...
    private void loadDiarioGeneral() {
        ...
        contDiarioGeneral.setCodModulo(MOD_CONTABILIDAD.ANULAR_PRESCRIPCION);
    }
