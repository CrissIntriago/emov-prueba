 ...
 */
@Named(value = "thPrestamoHipotecarioView")
@ViewScoped
public class ThPrestamoHipotecarioController implements Serializable {
    ...
    public void updateLazyModel() {
        if (thTipoRol != null) {
            ...
            thPrestamoQuirografarioLazy.getFilterss().put("ph", true);
    ...
    private String findThConfig(boolean accion) {
        String mensaje = "";
        thConfig = thConfigService.findCode(CONFIG.CONFIG_PH);
        if (thConfig == null) {
