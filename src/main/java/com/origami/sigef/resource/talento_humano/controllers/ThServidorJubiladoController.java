 ...
 */
@Named(value = "thServidorJubiladoView")
@ViewScoped
public class ThServidorJubiladoController implements Serializable {
    ...
    private Boolean editView, collapsed;
    ...
    public void init() {
        ...
        this.thservidorLazy.getFilterss().put("jubilado", true);
...
//        }
    ...
    public void imprimirReporte(String tipoDocumento) {
        servletSession.addParametro("parametro", true);
    ...
    public void openDlgDelete(Servidor servidor) {
