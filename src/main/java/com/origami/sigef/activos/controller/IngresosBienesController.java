 ...
 */
@Named(value = "ingresosBienesView")
@ViewScoped
public class IngresosBienesController extends BpmnBaseRoot implements Serializable {

    private static final Logger LOG = Logger.getLogger(IngresosBienesController.class.getName());
