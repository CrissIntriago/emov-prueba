...
public class AdquisicionesController implements Serializable {
    ...
    public void save() {
        ...
        if (edit) {
            ...
            /*Validacion contrato existente*/
            if (adquisicionesService.existeAdquisicion(adquisiciones)) { //!
                JsfUtil.addErrorMessage("ERROR!!", "Contrato ya ha sido registrado");
                return;
            }
            for (ResponsableAdquisicion responsable : responsableList) {
...
//</editor-fold>    
    ...
    public void subirArchivo(FileUploadEvent event) {
        ...
        JsfUtil.addInformationMessage("INFO!!", "El archivo a sido subido correctamente");
    }
