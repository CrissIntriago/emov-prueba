...
import com.origami.sigef.procesos.ComprobantePagoProcesoController;
 ...
 * @author jintr
 */
@Named(value = "generarComprobantePagoView")
@ViewScoped
public class ComprobantePagoController extends BpmnBaseRoot implements Serializable {
    ...
    public void completarTarea() {
        try {
            if (getTramite().getTipoTramite().getAbreviatura().equals("PAGORMU")) {
            ...
            getParamts().put("usuarioTesoreria", clienteService.getrolsUser(RolUsuario.archivoSPI));
