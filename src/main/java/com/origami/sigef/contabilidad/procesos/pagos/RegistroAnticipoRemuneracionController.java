...
import com.origami.sigef.talentohumano.beans.AnticipoRemuneracionController;
 ...
 * @author jintr
 */
@Named(value = "solicitudAnticipoView")
@ViewScoped
public class RegistroAnticipoRemuneracionController extends BpmnBaseRoot implements Serializable {
