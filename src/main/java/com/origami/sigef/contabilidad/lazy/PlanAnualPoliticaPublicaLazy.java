 ...
 */
public class PlanAnualPoliticaPublicaLazy extends LazyModel<PlanAnualPoliticaPublica> {
    ...
    public PlanAnualPoliticaPublicaLazy() {
        super(PlanAnualPoliticaPublica.class);
        this.getSorteds().put("id", "ASC");
        this.ignoreFilters = new ArrayList<>();
    }

    public PlanAnualPoliticaPublicaLazy(OpcionBusqueda busqueda) {
        super(PlanAnualPoliticaPublica.class);
        this.getSorteds().put("id", "ASC");
    ...
    public PlanAnualPoliticaPublicaLazy(OpcionBusqueda busqueda, BigInteger num) {
        super(PlanAnualPoliticaPublica.class);
        this.getSorteds().put("id", "ASC");
        this.num = num;
        this.busqueda = busqueda;
