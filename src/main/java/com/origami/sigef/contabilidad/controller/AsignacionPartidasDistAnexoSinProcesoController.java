 ...
 * @author Luis Suarez
 */
@Named(value = "asignacionPDASinProcesoView")
@ViewScoped
public class AsignacionPartidasDistAnexoSinProcesoController implements Serializable {
...
//            updateCuposTotales();
    ...
    public void deletePartida(PartidasDistributivoAnexo p) {
        try {
            ...
            PrimeFaces.current().ajax().update("formAsignacionDitributivo");
        } catch (Exception e) {
