 ...
 * @author Luis Suarez
 */
@Named(value = "partidasDistributivoSinProcesoView")
@ViewScoped
public class PartidasDistributivoSinProcesoController implements Serializable {
    ...
    public void editarCeldas(PartidasDistributivo p) {
        ...
        try {
            ...
            if (p.getItemAp() != null && p.getEstructuraAp() != null && p.getFuenteAp() != null) {
                ...
                p.setReformaCodificado(p.getDistributivo().getValorResultante());
