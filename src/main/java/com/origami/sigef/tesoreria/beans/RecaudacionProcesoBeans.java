 ...
 */
@Named(value = "recaudacionProcesoView")
@ViewScoped
public class RecaudacionProcesoBeans extends BpmnBaseRoot implements Serializable {
    ...
    private String codigo, codigoAjuste;
    ...
    public void init() {
        ...
        bancoOrigenList = detalleCorteService.bancoOrigenListbyNumTramite(tramite.getNumTramite());
        ...
        lazy.getFilterss().put("numTramite", tramite.getNumTramite());
    ...
    public void guardar() {
        if (edit) {
            ...
            recaudacion.setNumTramite(tramite.getNumTramite());
    ...
    public void guardarAjuste() {
        ...
        if (editAj) {
            ...
            ajuste.setNumTramite(tramite.getNumTramite());
    ...
    private void deleteRegisterCobros() {
        List<Recaudacion> recaudaciones = recaudacionService.getListRecaudacionesByNumTramite(tramite.getNumTramite());
        if (recaudaciones != null) {
            for (Recaudacion r : recaudaciones) {
                r.setEstado(Boolean.FALSE);
                recaudacionService.edit(r);
            }
        }
    ...
    public void realizarCobro(Recaudacion rc) {
        ...
        JsfUtil.redirectFaces("/proceso/CierreCaja/registrorecaudacioncobro");
    }

    public void realizarAjuste(Recaudacion rc) {
        userSession.setVarTemp(rc);
        JsfUtil.redirectFaces("/proceso/CierreCaja/ajusteRecaudacion");
    }
    ...
    public void abriDlogo(int opcion) {
        this.opcion = opcion;
