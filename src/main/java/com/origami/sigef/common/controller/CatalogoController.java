...
public class CatalogoController implements Serializable {
    ...
    private List<CatalogoItem> listaItem, listaAux;
    ...
    public void save() {
        ...
        if (!edit) {
            ...
            if (!listaAux.isEmpty()) {
                System.out.println("Desactivar en Producción: ");
                for (CatalogoItem c : listaAux) {
                    System.out.println("catalogo item: " + c.getDescripcion());
                    catalogoItemService.deleteCatalogoItems(c);
                }
            }
        }
