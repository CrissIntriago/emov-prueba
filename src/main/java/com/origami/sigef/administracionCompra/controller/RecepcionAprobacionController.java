 ...
 */
@Named(value = "recepcionAprobacionView")
@ViewScoped
public class RecepcionAprobacionController extends BpmnBaseRoot implements Serializable {
    ...
    public void abriDlogo(int codigo) {
        this.codigoAprobacion = codigo;
    ...
    public void completarTarea() {
        try {
            ...
            getParamts().put("aprobacionGerente", codigoAprobacion);
            if (codigoAprobacion == 1) {
                getParamts().put("usuarioResponsable", clienteService.getrolsUser(RolUsuario.comprasPublicas));
            }
            if (saveTramite() == null) {
                return;
            }
