 ...
 */
public class EstructuraProgramaPresupuestarioLazy extends LazyModel<EstructuraProgramaPresupuestario> {

    private static final long serialVersionUID = 1L;
    private OpcionBusqueda busqueda;
    private Short anio;

    public EstructuraProgramaPresupuestarioLazy() {
        super(EstructuraProgramaPresupuestario.class);
        this.getSorteds().put("codigo", "ASC");
        this.ignoreFilters = new ArrayList<>();
    }

    public EstructuraProgramaPresupuestarioLazy(Short anio) {
        super(EstructuraProgramaPresupuestario.class);
        this.getSorteds().put("codigo", "ASC");
        this.ignoreFilters = new ArrayList<>();
        this.anio = anio;
    ...
    public EstructuraProgramaPresupuestarioLazy(OpcionBusqueda busqueda) {
        super(EstructuraProgramaPresupuestario.class);
        this.getSorteds().put("codigo", "ASC");
