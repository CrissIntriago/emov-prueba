...
import static com.origami.sigef.Presupuesto.Controller.RevisionInformeReformaIngresoEgresoController.isNullOrEmpty;
 ...
 * @author ORIGAMIEC
 */
@Named(value = "revisionReformaPappView")
@ViewScoped
public class RevisionPappReformaController extends BpmnBaseRoot implements Serializable {
...
//LAZY
    ...
    private Boolean enbaledReformas;
    ...
    public void abriDlogo(boolean aprobar) {
        ...
        traermeUnidadeasCupos(reformaSuplemento);
        PrimeFaces.current().executeScript("PF('dlgObservaciones').show()");
        PrimeFaces.current().ajax().update(":frmDlgObser");

    }

    public void traermeUnidadeasCupos(ReformaIngresoSuplemento re) {
        List<Cupos> entidadCupos = new ArrayList<>();
        usuariosScoma = new ArrayList<>();
        usuariosScoma = new ArrayList<>();
        entidadCupos = cuposService.getCuposDetalle(re);
...
//</editor-fold>
    ...
    public Boolean getEnbaledReformas() {
        return enbaledReformas;
    }

    public void setEnbaledReformas(Boolean enbaledReformas) {
        this.enbaledReformas = enbaledReformas;
    }
