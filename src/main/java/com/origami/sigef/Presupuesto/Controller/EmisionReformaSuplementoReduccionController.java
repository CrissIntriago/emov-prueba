 ...
 * @author Luis Suarez
 */
@Named(value = "reformaInformeSrView")
@ViewScoped
public class EmisionReformaSuplementoReduccionController extends BpmnBaseRoot implements Serializable {
    ...
    public void inicalizar() {
        try {
            if (this.session.getTaskID() != null) {
                ...
                lazyReforma.getFilterss().put("tipo:equal", true);
...
//        ss.addParametro("SUBREPORT_DIR", JsfUtil.getRealPath("/reportes/"));
    ...
    public void completarTarea() {
        try {
            ...
            getParamts().put("usuarioaprobacionfi", clienteService.getrolsUser(RolUsuario.financiero));
            if (saveTramite() == null) {
                return;
            }
