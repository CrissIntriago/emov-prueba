 ...
 */
@Named(value = "revisionDocumentoTraspasoView")
@ViewScoped
public class ReformaRevisionDocTraspasoController extends BpmnBaseRoot implements Serializable {
...
//        lazyReformaTraspaso.getFilterss().put("id:equal", reformaTraspaso.getId());
    ...
    public void consultarReforma(ReformaTraspaso reforma) {
        ...
        listaProducto = reformaTraspasoService.getListProductoByReformaConsulta2(reformaTraspaso.getPeriodo(), BigInteger.valueOf(reformaTraspaso.getId()));
...
//        listaPlanProgramatico = planProgramaticoService.findByNamedQuery("PlanProgramatico.findByNivelPeriodo", true, 3, busqueda.getAnio());
