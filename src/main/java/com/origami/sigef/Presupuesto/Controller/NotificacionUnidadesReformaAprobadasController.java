 ...
 * @author Luis Suarez
 */
@Named(value = "notifcacionUnidadesReView")
@ViewScoped
public class NotificacionUnidadesReformaAprobadasController extends BpmnBaseRoot implements Serializable {
    ...
    public void inicializar() {
        ...
        try {
            if (this.session.getTaskID() != null) {
                ...
                r = cuposService.getReformaTramite(BigInteger.valueOf(tramite.getNumTramite()));
                unidadesConCupo = cuposService.getCuposDetalleUnidades(r);
            } else {
    ...
    public void enviarNotitifacion() {
        ...
        entidadCupos = cuposService.getCuposDetalle(r);
