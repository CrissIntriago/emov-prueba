 ...
 * @author ricar
 */
public class FinaRenPagoRubroService extends AbstractService<FinaRenPagoRubro> {

    private static final Logger LOG = Logger.getLogger(FinaRenPagoRubroService.class.getName());
    ...
    public FinaRenPagoRubroService() {
        super(FinaRenPagoRubro.class);
    }
