...
@Named
@ViewScoped
public class SeguimientoPermisos implements  Serializable {

    private static final long serialVersionUID = 1L;
    private static final Logger LOG = Logger.getLogger(SeguimientoPermisos.class.getName());
    ...
    public void actualizarTabla() {
        if (opcionBusqueda.getAnio() != null) {
            ...
            lazy.getSorteds().put("startTime", "DESC");            
             lazy.getFilterss().put("idTipoTramite.id", Arrays.asList(61L));
