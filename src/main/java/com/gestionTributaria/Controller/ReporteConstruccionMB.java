...
@Named
@ViewScoped
public class ReporteConstruccionMB implements Serializable {
    ...
    public void initView() {
        try {
            ...
            tipoReporteLiquiList = service.findAllQuery("SELECT r FROM FinaRenTipoLiquidacion r WHERE r.transaccionPadre=116 AND r.nombreTransaccion IS NOT NULL and r.estado = true"
