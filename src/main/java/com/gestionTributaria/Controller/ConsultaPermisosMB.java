...
@Named
@ViewScoped
public class ConsultaPermisosMB implements Serializable {

    private static final Logger LOG = Logger.getLogger(ConsultaPermisosMB.class.getName());
    ...
    public void consultarComisaria() {
        ...
        lazy.getFilterss().put("origen", "VIA_PUBLICA");
