...
@Named
@ViewScoped
public class ReporteEspacionPublicosMB implements Serializable {
    ...
    public void initView() {
        try {
            ...
            tipoReporteLiquiList = service.findAllQuery("SELECT r FROM FinaRenTipoLiquidacion r WHERE r.transaccionPadre=180 AND r.nombreTransaccion IS NOT NULL and r.estado = true"
    ...
    public void generarReporteCajero(Boolean excel) {
        try {
            ...
            if (!detallado) {
                ...
                ss.setNombreReporte("resumidoOtros");
                ...
                ss.addParametro("estado", estado);
                ss.addParametro("user_impresion", session.getNameUser());
                ss.setNombreReporte("detalladoOtros");
