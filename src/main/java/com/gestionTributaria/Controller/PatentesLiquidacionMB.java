 ...
 */
@Named(value = "patenteLiquidacionView")
@ViewScoped
public class PatentesLiquidacionMB extends ReportGenealModel implements Serializable {

    private static final Logger LOG = Logger.getLogger(PatentesLiquidacionMB.class.getName());
    @Inject
...
//                }
    ...
    public void procesar() {
        ...
        if (patenteShow) {
            ...
            try {
                ...
                patente = localSel.getPatente();
                Object numLiquidacion = null;
                liquidacionPatente.setObservacion(observacion);
                liquidacionPatente.setTipoLiquidacion(tipoLiquidacionPatente);
        ...
        if (habilitacionShow) {
            liquidacionHabilitacion.setLocalComercial(localSel);
            liquidacionHabilitacion.setObservacion(observacion);
            liquidacionHabilitacion.setTipoLiquidacion(tipoLiquidacionHabilitacion);
        ...
        if (permisoAdicionalesShow) {
            liquidacionPermisosAdicionales.setLocalComercial(localSel);
            liquidacionPermisosAdicionales.setObservacion(observacion);
        ...
        JsfUtil.executeJS("PF('dlgObs').hide()");
    ...
    public ParticipacionCantonesServices getParticipacionCantonesServices() {
        return participacionCantonesServices;
    }

    public void setParticipacionCantonesServices(ParticipacionCantonesServices participacionCantonesServices) {
        this.participacionCantonesServices = participacionCantonesServices;
    }
