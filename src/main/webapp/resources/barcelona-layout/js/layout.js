...
PrimeFaces.widget.BarcelonaMenu = PrimeFaces.widget.BaseWidget.extend({
    ...
    _bindEvents: function () {
        ...
        }).contextmenu(function (ex) {
//            ex.preventDefault();
            var link = $(this),
                    item = link.parent(),
                    submenu = item.children('ul');
            console.log("context menu " + item.hasClass('active-menuitem'));
            console.log("context menu " + ex.which);
        ...
        /*
         .off('contextmenu').on('contextmenu', function (ex) {
//            ex.preventDefault();
            var link = $(this),
                    item = link.parent(),
                    submenu = item.children('ul');
